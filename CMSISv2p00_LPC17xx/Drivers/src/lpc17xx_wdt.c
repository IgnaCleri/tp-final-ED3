...
/********************************************************************/ /**
                                                                        * @brief 		Set WDT time
                                                                        * out value and WDT mode
                                                                        * @param[in]	clk_source
                                                                        * select Clock source for
                                                                        * WDT device
                                                                        * @param[in]	timeout
                                                                        * value of time-out for WDT
                                                                        * (us)
                                                                        * @return		None
                                                                        *********************************************************************/
static uint8_t WDT_SetTimeOut(uint8_t clk_source, uint32_t timeout) {
...
/*********************************************************************/ /**
                                                                         * @brief 		Initial for
                                                                         * Watchdog function Clock
                                                                         * source = RTC ,
                                                                         * @param[in]	ClkSrc
                                                                         * Select clock source,
                                                                         * should be:
                                                                         * 				-
                                                                         * WDT_CLKSRC_IRC: Clock
                                                                         * source from Internal RC
                                                                         * oscillator
                                                                         * 				-
                                                                         * WDT_CLKSRC_PCLK: Selects
                                                                         * the APB peripheral clock
                                                                         * (PCLK)
                                                                         * 				-
                                                                         * WDT_CLKSRC_RTC: Selects
                                                                         * the RTC oscillator
                                                                         * @param[in]	WDTMode WDT
                                                                         * mode, should be:
                                                                         * 				-
                                                                         * WDT_MODE_INT_ONLY: Use
                                                                         * WDT to generate interrupt
                                                                         * only
                                                                         * 				-
                                                                         * WDT_MODE_RESET: Use WDT
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * activity with given
                                                                         * timeout value
                                                                         * @param[in]	TimeOut WDT
                                                                         * reset after timeout if it
                                                                         * is not feed
                                                                         * @return 		None
                                                                         **********************************************************************/
...
/********************************************************************/ /**
                                                                        * @brief 		After set
                                                                        * WDTEN, call this function
                                                                        * to start Watchdog or
