...
/*********************************************************************/ /**
                                                                         ...
                                                                         * disabled. This blocks SSP
                                                                         * controller from driving
                                                                         * the transmit data line
                                                                         * (MISO) Note:         This
                                                                         * function is available
                                                                         * when SSP peripheral in
                                                                         * Slave mode
                                                                         * @return         None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_SSP1: SSP1 peripheral
                                                                         * @param[in]    Data  Data
                                                                         * to transmit (must be 16
                                                                         * or 8-bit long, this
                                                                         * depend on SSP data bit
                                                                         * number configured)
                                                                         * @return         none
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Interrupt mode
                                                                         * @return         Actual
                                                                         * Data length has been
                                                                         * transferred in polling
                                                                         * mode. In interrupt mode,
                                                                         * always return (0) Return
                                                                         * (-1) if error. Note: This
    ...
    // Interrupt mode ----------------------------------------------------------------------
        ...
        while ((SSPx->SR & SSP_SR_TNF) && (dataCfg->tx_cnt != dataCfg->length)) {
            ...
            if (dataCfg->tx_data == NULL) {
                ...
                if (dataword == 0) {
                    SSP_SendData(SSPx,
                                 (*(uint8_t *)((uint32_t)dataCfg->tx_data + dataCfg->tx_cnt)));
                    dataCfg->tx_cnt++;
                } else {
                    SSP_SendData(SSPx,
                                 (*(uint16_t *)((uint32_t)dataCfg->tx_data + dataCfg->tx_cnt)));
                    dataCfg->tx_cnt += 2;
                }
            }
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_SSP1: SSP1 peripheral
                                                                         * @param[in]    FlagType
                                                                         * Type of flag to check
                                                                         * status, should be one of
                                                                         * following:
                                                                         *                            -
                                                                         * SSP_STAT_TXFIFO_EMPTY: TX
                                                                         * FIFO is empty
                                                                         *                            -
                                                                         ...
                                                                         *                            -
                                                                         * SSP_STAT_RXFIFO_FULL: RX
                                                                         * FIFO is full
                                                                         *                            -
                                                                         * SSP_STAT_BUSY: SSP
                                                                         * peripheral is busy
                                                                         * @return        New State
                                                                         * of specified SSP status
                                                                         * flag
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Overrun interrupt
                                                                         *                 -
                                                                         * SSP_INTCFG_RT: Receive
                                                                         * Time out interrupt
                                                                         *                 -
                                                                         * SSP_INTCFG_RX: RX FIFO is
                                                                         * at least half full
                                                                         * interrupt
                                                                         *                 -
                                                                         * SSP_INTCFG_TX: TX FIFO is
                                                                         * at least half empty
                                                                         * interrupt
                                                                         * @param[in]    NewState
                                                                         * New State of specified
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * interrupt
                                                                         *                 -
                                                                         * SSP_INTSTAT_RAW_RX: RX
                                                                         * FIFO is at least half
                                                                         * full interrupt
                                                                         *                 -
                                                                         * SSP_INTSTAT_RAW_TX: TX
                                                                         * FIFO is at least half
                                                                         * empty interrupt
                                                                         * @return    New State of
                                                                         * specified Raw interrupt
                                                                         * status flag in SSP
                                                                         * peripheral Note:
                                                                         * Enabling/Disabling
                                                                         * specified interrupt in
                                                                         * SSP peripheral does not
                                                                         *         effect to Raw
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Overrun interrupt
                                                                         *                 -
                                                                         * SSP_INTSTAT_RT: Receive
                                                                         * Time out interrupt
                                                                         *                 -
                                                                         * SSP_INTSTAT_RX: RX FIFO
                                                                         * is at least half full
                                                                         * interrupt
                                                                         *                 -
                                                                         * SSP_INTSTAT_TX: TX FIFO
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * when RxFIFO was full"
                                                                         * interrupt.
                                                                         *                         -
                                                                         * SSP_INTCLR_RT: clears the
                                                                         * "Rx FIFO was not empty
                                                                         * and has not been read for
                                                                         * a timeout period"
                                                                         * interrupt.
                                                                         * @return        None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_SSP1: SSP1 peripheral
                                                                         * @param[in]    DMAMode
                                                                         * Type of DMA, should be:
                                                                         *                         -
                                                                         * SSP_DMA_TX: DMA for the
                                                                         * transmit FIFO
                                                                         *                         -
                                                                         * SSP_DMA_RX: DMA for the
                                                                         * Receive FIFO
                                                                         * @param[in]    NewState
                                                                         * New State of DMA function
                                                                         * on SSP peripheral, should
                                                                         * be:
                                                                         *                         -
                                                                         * ENALBE: Enable this
                                                                         * function
