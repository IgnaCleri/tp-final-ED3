...
/*********************************************************************/ /**
                                                                         * @brief        Get data
                                                                         * bit size per transfer
                                                                         * @param[in]    SPIx    SPI
                                                                         * peripheral selected,
                                                                         * should be LPC_SPI
                                                                         * @return         number of
                                                                         * bit per transfer, could
                                                                         * be 8-16
                                                                         **********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        *               parameters
                                                                        * in the UART_ConfigStruct.
                                                                        * @param[in]    SPIx    SPI
                                                                        * peripheral selected,
                                                                        * should be LPC_SPI
                                                                        * @param[in]
                                                                        * SPI_ConfigStruct Pointer
                                                                        * to a SPI_CFG_Type
...
/********************************************************************/ /**
                                                                        ...
                                                                        * peripheral selected,
                                                                        * should be LPC_SPI
                                                                        * @param[in]    NewState New
                                                                        * state of specified UART
                                                                        * interrupt type, should be:
                                                                        *                 - ENALBE:
                                                                        * Enable this SPI interrupt.
                                                                        *                 - DISALBE:
                                                                        * Disable this SPI
                                                                        * interrupt.
                                                                        * @return         None
...
/********************************************************************/ /**
                                                                        * @brief         Checks
                                                                        * whether the SPI interrupt
                                                                        * flag is set or not.
                                                                        * @param[in]    SPIx    SPI
                                                                        * peripheral selected,
                                                                        * should be LPC_SPI
                                                                        * @return         The new
                                                                        * state of SPI Interrupt
                                                                        * Flag (SET or RESET)
                                                                        *********************************************************************/
...
/********************************************************************/ /**
                                                                        ...
                                                                        *             SPI_CheckStatus()
                                                                        * to determine current flag
                                                                        * status corresponding to
                                                                        * each SPI status type.
                                                                        * Because some flags in SPI
                                                                        * Status register will be
                                                                        * cleared after reading, the
                                                                        * next reading SPI Status
                                                                        * register could not be
                                                                        * correct. So this function
                                                                        * used to read SPI status
                                                                        * register in one time only,
                                                                        * then the return value used
                                                                        * to check all flags.
                                                                        *********************************************************************/
