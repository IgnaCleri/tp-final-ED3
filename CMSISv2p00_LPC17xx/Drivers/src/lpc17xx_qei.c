...
/*********************************************************************/ /**
                                                                         * @brief		Resets value
                                                                         * for each type of QEI
                                                                         * value, such as velocity,
                                                                         * 				counter,
                                                                         * position, etc..
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
                                                                         * @param[in]	ulResetType
                                                                         *	QEI Reset Type, should
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *	QEI_ConfigStruct
                                                                         *	Pointer to a
                                                                         * QEI_CFG_Type structure
                                                                         *                    that
                                                                         * contains the
                                                                         * configuration information
                                                                         * for the specified QEI
                                                                         * peripheral
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Check
                                                                         * whether if specified flag
                                                                         * status is set or not
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
                                                                         * @param[in]	ulFlagType
                                                                         *	Status Flag Type, should
                                                                         * be one of the following:
                                                                         * 							-
                                                                         * QEI_STATUS_DIR: Direction
                                                                         * Status
                                                                         * @return		New Status
                                                                         * of this status flag (SET
                                                                         * or RESET)
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Get current
                                                                         * position value in QEI
                                                                         * peripheral
                                                                         * @param[in]	QEIx	QEI
                                                                         * peripheral, should be
                                                                         * LPC_QEI
                                                                         * @return		Current
                                                                         * position value of QEI
                                                                         * peripheral
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Set max
                                                                         * position value for QEI
                                                                         * peripheral
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
                                                                         * @param[in]	ulMaxPos
                                                                         *	Max position value to
                                                                         * set
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * channel, should be:
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_0: QEI
                                                                         * compare position channel
                                                                         * 0
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_1: QEI
                                                                         * compare position channel
                                                                         * 1
                                                                         * 							-
                                                                         * QEI_COMPPOS_CH_2: QEI
                                                                         * compare position channel
                                                                         * 2
                                                                         * @param[in]	ulPosComp
...
/*********************************************************************/ /**
                                                                         * @brief		Set value
                                                                         * for index compare in QEI
                                                                         * peripheral
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
                                                                         * @param[in]	ulIndexComp
                                                                         *	Compare Index Value to
                                                                         * set
                                                                         * @return		None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief		Set timer
                                                                         * reload value for QEI
                                                                         * peripheral. When the
                                                                         * velocity timer is
                                                                         * 				over-flow,
                                                                         * the value that set for
                                                                         * Timer Reload register
                                                                         * will be loaded into the
                                                                         * velocity timer for next
                                                                         * period. The calculated
                                                                         * velocity in RPM therefore
                                                                         * will be affect by this
                                                                         * value.
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
...
/*********************************************************************/ /**
                                                                         * @brief		Get the most
                                                                         * recently measured
                                                                         * velocity of the QEI. When
                                                                         * 				the Velocity
                                                                         * timer in QEI is
                                                                         * over-flow, the current
                                                                         * velocity value will be
                                                                         * loaded into Velocity
                                                                         * Capture register.
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
...
/*********************************************************************/ /**
                                                                         * @brief		Set value of
                                                                         * sampling count for the
                                                                         * digital filter in QEI
                                                                         * peripheral
                                                                         * @param[in]	QEIx
                                                                         *	QEI peripheral, should
                                                                         * be LPC_QEI
                                                                         * @param[in]
                                                                         *	ulSamplingPulse	Value of
...
/*********************************************************************/ /**
  ...
  * @param[in]	ulIntType		Interrupt Flag Status type, should be:
  ...
  interrupt
                                 ...
                                 - QEI_INTFLAG_POS0REV_Int: Combined position 0 and revolution count
  interrupt
                                 - QEI_INTFLAG_POS1REV_Int: Combined position 1 and revolution count
  interrupt
                                 - QEI_INTFLAG_POS2REV_Int: Combined position 2 and revolution count
  interrupt
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *								-
                                                                         * QEI_INTFLAG_TIM_Int:
                                                                         * Velocity timer over flow
                                                                         * interrupt
                                                                         *								-
                                                                         * QEI_INTFLAG_VELC_Int:
                                                                         * Capture velocity is less
                                                                         ...
                                                                         *								-
                                                                         * QEI_INTFLAG_REV_Int:
                                                                         * Index compare value is
                                                                         * equal to the current
                                                                         *														index
                                                                         * count interrupt
                                                                         *								-
                                                                         * QEI_INTFLAG_POS0REV_Int:
                                                                         * Combined position 0 and
                                                                         * revolution count
                                                                         * interrupt
                                                                         *								-
                                                                         * QEI_INTFLAG_POS1REV_Int:
                                                                         * Combined position 1 and
                                                                         * revolution count
                                                                         * interrupt
                                                                         *								-
                                                                         * QEI_INTFLAG_POS2REV_Int:
                                                                         * Combined position 2 and
                                                                         * revolution count
                                                                         * interrupt
                                                                         * @param[in]	NewState
                                                                         *	New function state,
...
/*********************************************************************/ /**
                                                                         * @brief		Calculates
                                                                         * the actual velocity in
                                                                         * RPM passed via velocity
                                                                         * 				capture
                                                                         * value and Pulse Per Round
                                                                         ...
                                                                         * be LPC_QEI
                                                                         * @param[in]
                                                                         *	ulVelCapValue	Velocity
                                                                         * capture input value that
                                                                         * can be got from
                                                                         * QEI_GetVelocityCap()
                                                                         * function
                                                                         * @param[in]	ulPPR
