...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Counter increment
                                                                         * interrupt for each time
                                                                         * type in RTC peripheral
                                                                         * @param[in]    RTCx    RTC
                                                                         * peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]
                                                                         * CntIncrIntType: Counter
                                                                         * Increment Interrupt type,
                                                                         *                 an
                                                                         * increment of this type
                                                                         * value below will
                                                                         ...
                                                                         *                 - ENABLE:
                                                                         * Counter Increment
                                                                         * interrupt for this time
                                                                         * type are enabled
                                                                         *                 -
                                                                         * DISABLE: Counter
                                                                         * Increment interrupt for
                                                                         * this time type are
                                                                         * disabled
                                                                         * @return         None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * should be LPC_RTC
                                                                         * @param[in]
                                                                         * AlarmTimeType: Alarm Time
                                                                         * Interrupt type, an
                                                                         * matching of this type
                                                                         * value below with current
                                                                         * time in RTC will
                                                                         * generates an interrupt,
                                                                         * should be:
                                                                         *                 -
                                                                         ...
                                                                         * function, should be:
                                                                         *                 - ENABLE:
                                                                         * Alarm interrupt for this
                                                                         *                     time
                                                                         * type are enabled
                                                                         *                 -
                                                                         * DISABLE: Alarm interrupt
                                                                         * for this time type are
                                                                         * disabled
                                                                         * @return         None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief         Set
                                                                         * current time value for
                                                                         * each time type in RTC
                                                                         * peripheral
                                                                         * @param[in]    RTCx    RTC
                                                                         * peripheral selected,
                                                                         * should be LPC_RTC
...
/*********************************************************************/ /**
                                                                         * @brief         Set full
                                                                         * of time in RTC peripheral
                                                                         * @param[in]    RTCx    RTC
                                                                         * peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]    pFullTime
                                                                         * Pointer to a
                                                                         * RTC_TIME_Type structure
                                                                         * that contains time value
                                                                         * in full.
                                                                         * @return         None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * Location interrupt in RTC
                                                                         * peripheral is set or not
                                                                         * @param[in]    RTCx    RTC
                                                                         * peripheral selected,
                                                                         * should be LPC_RTC
                                                                         * @param[in]    IntType
                                                                         * Interrupt location type,
                                                                         * should be:
                                                                         *                         -
                                                                         * RTC_INT_COUNTER_INCREASE:
                                                                         * Counter Increment
                                                                         * Interrupt block generated
                                                                         * an interrupt.
                                                                         *                         -
                                                                         * RTC_INT_ALARM: Alarm
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * should be LPC_RTC
                                                                         * @param[in]    CalibValue
                                                                         * Calibration value, should
                                                                         * be in range from 0 to
                                                                         * 131,072
                                                                         * @param[in]    CalibDir
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return         None
                                                                         * Note: These General
                                                                         * purpose registers can be
                                                                         * used to store important
                                                                         * information when the main
                                                                         * power supply is off. The
                                                                         * value in these registers
                                                                         * is not affected by chip
                                                                         * reset.
                                                                         **********************************************************************/
