...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return        None
                                                                         **********************************************************************/
void UARTPutChar(LPC_UART_TypeDef *UARTx, uint8_t ch) { UART_Send(UARTx, &ch, 1, BLOCKING); }
...
/*********************************************************************/ /**
                                                                         * @brief        Puts a
                                                                         * decimal number to UART
                                                                         * port
                                                                         * @param[in]    UARTx
                                                                         * Pointer to UART
                                                                         * peripheral
                                                                         * @param[in]    decnum
                                                                         * Decimal number (8-bit
                                                                         * long)
                                                                         * @return        None
                                                                         **********************************************************************/
