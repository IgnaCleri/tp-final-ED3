...
#define PARAM_SSPx(n)                                                                              \
    ((((uint32_t *)n) == ((uint32_t *)LPC_SSP0)) || (((uint32_t *)n) == ((uint32_t *)LPC_SSP1)))
...
#define PARAM_SSP_STAT(n)                                                                          \
    ((n == SSP_STAT_TXFIFO_EMPTY) || (n == SSP_STAT_TXFIFO_NOTFULL) ||                             \
     (n == SSP_STAT_RXFIFO_NOTEMPTY) || (n == SSP_STAT_RXFIFO_FULL) || (n == SSP_STAT_BUSY))
...
#define PARAM_SSP_INTSTAT_RAW(n)                                                                   \
    ((n == SSP_INTSTAT_RAW_ROR) || (n == SSP_INTSTAT_RAW_RT) || (n == SSP_INTSTAT_RAW_RX) ||       \
     (n == SSP_INTSTAT_RAW_TX))
