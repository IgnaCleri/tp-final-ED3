...
/*********************************************************************/ /**
                                                                         * Macro defines for Global
                                                                         * FullCANInterrupt Enable
                                                                         * Register
                                                                         **********************************************************************/
...
#define PARAM_CANx(x)                                                                              \
    ((((uint32_t *)x) == ((uint32_t *)LPC_CAN1)) || (((uint32_t *)x) == ((uint32_t *)LPC_CAN2)))
...
#define PARAM_CTRL_STS_TYPE(n)                                                                     \
    ((n == CANCTRL_GLOBAL_STS) || (n == CANCTRL_INT_CAP) || (n == CANCTRL_ERR_WRN) ||              \
     (n == CANCTRL_STS))
...
#define PARAM_MODE_TYPE(n)                                                                         \
    ((n == CAN_OPERATING_MODE) || (n == CAN_RESET_MODE) || (n == CAN_LISTENONLY_MODE) ||           \
     (n == CAN_SELFTEST_MODE) || (n == CAN_TXPRIORITY_MODE) || (n == CAN_SLEEP_MODE) ||            \
...
#define PARAM_INT_EN_TYPE(n)                                                                       \
    ((n == CANINT_RIE) || (n == CANINT_TIE1) || (n == CANINT_EIE) || (n == CANINT_DOIE) ||         \
     (n == CANINT_WUIE) || (n == CANINT_EPIE) || (n == CANINT_ALIE) || (n == CANINT_BEIE) ||       \
     (n == CANINT_IDIE) || (n == CANINT_TIE2) || (n == CANINT_TIE3) || (n == CANINT_FCE))
