...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]    NewState
                                                                         * New State of I2C
                                                                         * peripheral interrupt in
                                                                         * NVIC core should be:
                                                                         *                 - ENABLE:
                                                                         * enable interrupt for this
                                                                         * I2C peripheral
                                                                         *                 -
                                                                         * DISABLE: disable
                                                                         * interrupt for this I2C
                                                                         * peripheral
                                                                         * @return         None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *
                                                                         * Note:
                                                                         * - In case of using I2C to
                                                                         * transmit data only,
                                                                         * either transmit length
                                                                         * set to 0 or transmit data
                                                                         * pointer set to NULL.
                                                                         * - In case of using I2C to
                                                                         * receive data only, either
                                                                         * receive length set to 0
                                                                         * or receive data pointer
                                                                         * set to NULL.
                                                                         * - In case of using I2C to
                                                                         * transmit followed by
                                                                         * receive data, transmit
                                                                         * length, transmit data
                                                                         * pointer, receive length
                                                                         * and receive data pointer
                                                                         * should be set
                                                                         * corresponding.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * on the I2C bus. If the
                                                                         * master send a SLA+W
                                                                         * command, this sub-routine
                                                                         * will use receive data
                                                                         * length and receive data
                                                                         * pointer. If the master
                                                                         * send a SLA+R command,
                                                                         * this sub-routine will use
                                                                         * transmit data length and
                                                                         * transmit data pointer. If
                                                                         * the master issue an
                                                                         * repeat start command or a
                                                                         * stop command, the slave
                                                                         * will enable an time out
                                                                         * condition, during time
                                                                         * out condition, if there's
                                                                         * no activity on I2C bus,
                                                                         * the slave will exit,
                                                                         * otherwise (i.e. the
                                                                         * master send a SLA+R/W),
                                                                         * the slave then switch to
                                                                         * relevant operation mode.
                                                                         * The time out should be
                                                                         * used because the return
                                                                         * status code can not show
                                                                         * difference from stop and
                                                                         * repeat start command in
                                                                         * slave operation. In case
                                                                         * of the expected data
                                                                         * length from master is
...
/*********************************************************************/ /**
                                                                         * @brief        Set Own
                                                                         * slave address in I2C
                                                                         * peripheral corresponding
                                                                         * to parameter specified in
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_I2C2
                                                                         * @param[in]
                                                                         * MonitorCfgType Monitor
                                                                         * Configuration type,
                                                                         * should be:
                                                                         *                 -
                                                                         * I2C_MONITOR_CFG_SCL_OUTPUT:
                                                                         * I2C module can 'stretch'
                                                                         *                 the clock
                                                                         * line (hold it low) until
                                                                         * it has had time to
                                                                         *                 respond
                                                                         * to an I2C interrupt.
                                                                         *                 -
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_I2C2
                                                                         * @return        None
                                                                         * Note:    In monitor mode,
                                                                         * the I2C module may lose
                                                                         * the ability to stretch
                                                                         * the clock (stall the bus)
                                                                         * if the ENA_SCL bit is not
                                                                         * set. This means that the
                                                                         * processor will have a
                                                                         * limited amount of time to
                                                                         * read the contents of the
                                                                         * data received on the bus.
                                                                         * If the processor reads
                                                                         * the I2DAT shift register,
                                                                         * as it ordinarily would,
                                                                         * it could have only one
                                                                         * bit-time to respond to
                                                                         * the interrupt before the
                                                                         * received data is
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * LPC_I2C2
                                                                         * @return         Master
                                                                         * transfer status, could
                                                                         * be:
                                                                         *                 - TRUE
                                                                         * master transfer completed
                                                                         *                 - FALSE
                                                                         * master transfer have not
                                                                         * completed yet
                                                                         **********************************************************************/
