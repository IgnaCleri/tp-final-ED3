...
/*********************************************************************/ /**
                                                                         * @brief		Set Station
                                                                         * MAC address for EMAC
                                                                         * module
                                                                         * @param[in]
                                                                         *	abStationAddr Pointer to
                                                                         * Station address that
                                                                         * contains 6-bytes of MAC
                                                                         * address (should be in
                                                                         * order from MAC Address 1
                                                                         * to MAC Address 6)
                                                                         * @return		None
                                                                         **********************************************************************/
static void setEmacAddr(uint8_t abStationAddr[]) {
...
/*********************************************************************/ /**
                                                                         * @brief		Calculates
                                                                         * CRC code for number of
                                                                         * bytes in the frame
                                                                         * @param[in]	frame_no_fcs
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *	EMAC_ConfigStruct
                                                                         * Pointer to a
                                                                         * EMAC_CFG_Type structure
                                                                         *                    that
                                                                         * contains the
                                                                         * configuration information
                                                                         * for the specified EMAC
                                                                         * peripheral.
                                                                         * @return		None
                                                                         *
                                                                         ...
                                                                         * condition from the MAC
                                                                         *  - Configure the PHY via
                                                                         * the MIIM interface of the
                                                                         * MAC
                                                                         *  - Select RMII mode
                                                                         ...
                                                                         * registers (MAC1,MAC2
                                                                         * etc.) in the MAC
                                                                         *  - Enable the receive and
                                                                         * transmit data paths In
                                                                         * default state after
                                                                         * initializing, only Rx
                                                                         * Done and Tx Done
                                                                         * interrupt are enabled,
                                                                         *  all remain interrupts
                                                                         * are disabled (Ref. from
                                                                         * LPC17xx UM)
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief
                                                                         *	De-initializes the EMAC
                                                                         * peripheral registers to
                                                                         * their default reset
                                                                         * values.
                                                                         * @param[in]	None
                                                                         * @return 		None
...
/*********************************************************************/ /**
                                                                         * @brief		Check
                                                                         * specified PHY status in
                                                                         * EMAC peripheral
                                                                         * @param[in]	ulPHYState
                                                                         *	Specified PHY Status
                                                                         * Type, should be:
                                                                         * 							-
                                                                         ...
                                                                         * Status
                                                                         * @return		Status of
                                                                         * specified PHY status (0
                                                                         * or 1).
                                                                         * 				(-1) if
                                                                         * error.
                                                                         *
                                                                         * Note:
                                                                         * For EMAC_PHY_STAT_LINK,
                                                                         * return value:
                                                                         * - 0: Link Down
                                                                         * - 1: Link Up
                                                                         * For EMAC_PHY_STAT_SPEED,
                                                                         * return value:
                                                                         * - 0: 10Mbps
                                                                         * - 1: 100Mbps
                                                                         * For EMAC_PHY_STAT_DUP,
                                                                         * return value:
                                                                         * - 0: Half-Duplex
                                                                         * - 1: Full-Duplex
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief
                                                                         *	Enable/Disable hash
                                                                         * filter functionality for
                                                                         * specified destination MAC
                                                                         * address in EMAC module
                                                                         * @param[in]	dstMAC_addr
                                                                         *	Pointer to the first MAC
                                                                         * destination address,
                                                                         * should be 6-bytes length,
                                                                         * in order LSB to the MSB
                                                                         * @param[in]	NewState
                                                                         *	New State of this
                                                                         * command, should be:
                                                                         *									-
                                                                         ...
                                                                         * (this CRC is calculated
                                                                         * anyway as part of
                                                                         * calculating the CRC of
                                                                         * the whole frame), then
                                                                         * bits [28:23] out of the
                                                                         * 32 bits CRC result are
                                                                         * taken to form the hash.
                                                                         * The 6 bit hash is used to
                                                                         * access the hash table: it
                                                                         * is used as an index in
                                                                         * the 64 bit HashFilter
                                                                         * register that has been
                                                                         * programmed with accept
                                                                         * values. If the selected
                                                                         * accept value is 1, the
                                                                         * frame is accepted.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * mode for each specified
                                                                         * type EMAC peripheral
                                                                         * @param[in]	ulFilterMode
                                                                         *	Filter mode, should be:
                                                                         * 								-
                                                                         * EMAC_RFC_UCAST_EN: all
                                                                         * frames of unicast types
                                                                         * 								will
                                                                         * be accepted
                                                                         * 								-
                                                                         * EMAC_RFC_BCAST_EN:
                                                                         ...
                                                                         * frames of multicast types
                                                                         * will be accepted
                                                                         * 								-
                                                                         * EMAC_RFC_UCAST_HASH_EN:
                                                                         * The imperfect hash filter
                                                                         * will be applied to
                                                                         * unicast addresses
                                                                         * 								-
                                                                         ...
                                                                         * be compared with the 6
                                                                         * byte station address
                                                                         * 								programmed
                                                                         * in the station address by
                                                                         * the filter
                                                                         * 								-
                                                                         * EMAC_RFC_MAGP_WOL_EN: the
                                                                         * result of the magic
                                                                         * 								packet
                                                                         * filter will generate a
                                                                         * WoL interrupt when there
                                                                         * is a match
                                                                         * 								-
                                                                         * EMAC_RFC_PFILT_WOL_EN:
                                                                         * the result of the perfect
                                                                         * address matching filter
                                                                         * and the imperfect hash
                                                                         * filter will generate a
                                                                         * WoL interrupt when there
                                                                         * is a match
                                                                         * @param[in]	NewState
...
/*********************************************************************/ /**
                                                                         * @brief		Get status
                                                                         * of Wake On LAN Filter for
                                                                         * each specified type in
                                                                         * EMAC peripheral, clear
                                                                         * this status if it is set
                                                                         * @param[in]	ulWoLMode
                                                                         *	WoL Filter mode, should
                                                                         * be:
                                                                         * 								-
                                                                         ...
                                                                         * 								-
                                                                         * EMAC_WOL_UCAST_HASH:
                                                                         * unicast frame that passes
                                                                         * the imperfect hash filter
                                                                         * caused WoL
                                                                         * 								-
                                                                         * EMAC_WOL_MCAST_HASH:
                                                                         * multicast frame that
                                                                         * passes the imperfect hash
                                                                         * filter caused WoL
                                                                         * 								-
...
/*********************************************************************/ /**
                                                                         * @brief		Write data
                                                                         * to Tx packet data buffer
                                                                         * at current index due to
                                                                         * 				TxProduceIndex
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * for each type in EMAC
                                                                         * @param[in]	ulIntType
                                                                         *	Interrupt Type, should
                                                                         * be:
                                                                         * 							-
                                                                         * EMAC_INT_RX_OVERRUN:
                                                                         * Receive Overrun
...
/*********************************************************************/ /**
                                                                         * @brief 		Check
                                                                         * whether if specified
                                                                         * interrupt flag is set or
                                                                         * not for each interrupt
                                                                         * type in EMAC and clear
                                                                         * interrupt pending if it
                                                                         * is set.
                                                                         * @param[in]	ulIntType
                                                                         *	Interrupt Type, should
                                                                         * be:
...
/*********************************************************************/ /**
                                                                         * @brief		Check
                                                                         * whether if the current
                                                                         * RxConsumeIndex is not
                                                                         ...
                                                                         * RxConsumeIndex is not
                                                                         * equal to the
                                                                         * RxProduceIndex, it means
                                                                         * there're available data
                                                                         * has been received. They
                                                                         * should be read out and
                                                                         * released the Receive Data
                                                                         * Buffer by updating the
                                                                         * RxConsumeIndex value.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *
                                                                         * Note: In case the
                                                                         * RxConsumeIndex is equal
                                                                         * to the RxProduceIndex -
                                                                         * 1, it means the transmit
                                                                         * buffer is available and
...
/*********************************************************************/ /**
                                                                         * @brief		Get current
                                                                         * status value of receive
                                                                         * data (due to
                                                                         * RxConsumeIndex)
                                                                         * @param[in]	ulRxStatType
...
/*********************************************************************/ /**
                                                                         * @brief		Get size of
                                                                         * current Received data in
                                                                         * received buffer (due to
                                                                         * 				RxConsumeIndex)
                                                                         * @param[in]	None
                                                                         * @return		Size of
                                                                         * received data
...
/*********************************************************************/ /**
                                                                         * @brief		Increase the
                                                                         * RxConsumeIndex (after
                                                                         * reading the Receive
                                                                         * buffer to release the
                                                                         * Receive buffer) and
                                                                         * wrap-around the index if
                                                                         * 				it reaches
                                                                         * the maximum Receive
                                                                         * Number
                                                                         * @param[in]	None
...
/*********************************************************************/ /**
                                                                         * @brief		Increase the
                                                                         * TxProduceIndex (after
                                                                         * writting to the Transmit
                                                                         * buffer to enable the
                                                                         * Transmit buffer) and
                                                                         * wrap-around the index if
                                                                         * 				it reaches
