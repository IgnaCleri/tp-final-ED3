...
/*********************************************************************/ /**
                                                                         * @brief        Write to
                                                                         * MCPWM shadow registers -
                                                                         * Update the value for
                                                                         * period and pulse width in
                                                                         * MCPWM peripheral.
                                                                         * @param[in]    MCPWMx
                                                                         *        Motor Control PWM
                                                                         * peripheral selected
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]    channelNum
                                                                         *       MCI (Motor Control
                                                                         * Input pin) number Should
                                                                         * be: 0..2
                                                                         * @param[in]  captureConfig
                                                                         *    Pointer to a
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return        None
                                                                         **********************************************************************/
void MCPWM_CountConfig(LPC_MCPWM_TypeDef *MCPWMx, uint32_t channelNum, uint32_t countMode,
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * be: LPC_MCPWM
                                                                         * @param[in]    channel0
                                                                         * State of this command on
                                                                         * channel 0:
                                                                         *                             -
                                                                         * ENABLE: 'Start' command
                                                                         * will effect on channel 0
                                                                         *                             -
                                                                         ...
                                                                         * @return        None
                                                                         **********************************************************************/
void MCPWM_Start(LPC_MCPWM_TypeDef *MCPWMx, uint32_t channel0, uint32_t channel1,
                 uint32_t channel2) {
    uint32_t regVal = 0;
...
/*********************************************************************/ /**
  ...
  **********************************************************************/
void MCPWM_DCMode(LPC_MCPWM_TypeDef *MCPWMx, uint32_t dcMode, uint32_t outputInvered,
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @return        None
                                                                         *
                                                                         * Note: all these ulIntType
                                                                         * values above can be ORed
                                                                         * together for using as
                                                                         * input parameter.
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         * @brief        Check
                                                                         * whether if the specified
                                                                         * interrupt in MCPWM is set
                                                                         * or not
                                                                         * @param[in]    MCPWMx
                                                                         *    Motor Control PWM
                                                                         * peripheral selected,
