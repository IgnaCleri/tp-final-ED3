...
/*********************************************************************/ /**
                                                                         * Macro defines for Non
                                                                         * Back-to-Back
                                                                         * Inter-Packet-Gap Register
                                                                         **********************************************************************/
/** Programmable field representing the Non-Back-to-Back Inter-Packet-Gap */
#define EMAC_IPGR_NBBIPG_P2(n) (n & 0x7F)
/** Recommended value for Programmable field representing the Non-Back-to-Back Inter-Packet-Gap Part
 * 1 */
...
#define EMAC_RINFO_ERR_MASK                                                                        \
    (EMAC_RINFO_FAIL_FILT | EMAC_RINFO_CRC_ERR | EMAC_RINFO_SYM_ERR | EMAC_RINFO_LEN_ERR |         \
     EMAC_RINFO_ALIGN_ERR | EMAC_RINFO_OVERRUN)

/*********************************************************************/ /**
                                                                         * Macro defines for TX
                                                                         * Descriptor Control Word
                                                                         **********************************************************************/
