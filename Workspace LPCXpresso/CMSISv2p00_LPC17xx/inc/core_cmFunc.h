...
/** \brief  Get ISPR Register
    ...
    \return               ISPR Register value
 */
static uint32_t __get_IPSR(void) { __ASM("mrs r0, ipsr"); }
...
/** \brief  Get APSR Register
    ...
    \return               APSR Register value
 */
static uint32_t __get_APSR(void) { __ASM("mrs r0, apsr"); }
...
/** \brief  Get Process Stack Pointer
    ...
    \return               PSP Register value
 */
static uint32_t __get_PSP(void) { __ASM("mrs r0, psp"); }
...
/** \brief  Set Process Stack Pointer
    ...
    \param [in]    topOfProcStack  Process Stack Pointer value to set
 */
static void __set_PSP(uint32_t topOfProcStack) { __ASM("msr psp, r0"); }
...
/** \brief  Get Main Stack Pointer
    ...
    \return               MSP Register value
 */
static uint32_t __get_MSP(void) { __ASM("mrs r0, msp"); }
...
/** \brief  Set Main Stack Pointer
    ...
    \param [in]    topOfMainStack  Main Stack Pointer value to set
 */
static void __set_MSP(uint32_t topOfMainStack) { __ASM("msr msp, r0"); }
