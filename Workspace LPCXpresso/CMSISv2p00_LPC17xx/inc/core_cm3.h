...
#define IntType_ACTLR_DISFOLD_Msk                                                                  \
    (1UL << IntType_ACTLR_DISFOLD_Pos) /*!< InterruptType ACTLR: DISFOLD Mask */
...
#define MPU_RASR_ENA_Msk                                                                           \
    (0x1UL << MPU_RASR_ENA_Pos) /*!< MPU RASR: Region enable bit Disable Mask */
...
/** \brief  System Tick Configuration
    ...
    This function initialises the system tick timer and its interrupt and start the system tick
   timer. Counter is in free running mode to generate periodical interrupts.
