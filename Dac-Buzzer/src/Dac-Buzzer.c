...
void conf_gpdma(void) {
    ...
    const GPDMA_Endpoint_T endpts = {
        ...
        .increment = ENABLE, .burst = GPDMA_BSIZE_1, .width = GPDMA_HALFWORD

    };

    const GPDMA_Endpoint_T endptd = {

        .increment = DISABLE, .burst = GPDMA_BSIZE_1, .width = GPDMA_HALFWORD

    };

    GPDMA_Channel_CFG_T confaudio = {.channelNum = GPDMA_CH_3,
                                     .transferSize = 4095,
                                     .type = GPDMA_M2P,
                                     .dstConn = GPDMA_DAC,
